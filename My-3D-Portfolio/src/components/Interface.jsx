...
const AboutSection = (props) => {
  ...
  return (
    <Section mobileTop>
      ...
      >
        I am a Java Software Developer fresher, developing, testing, and de-
        ploying web applications. I have a strong understanding of software
        engineering principles . My greatest accomplishment was creating a
        highly effective multi-threaded program to optimize the performance of a
        large-scale application. I have excellent problem-solving skills, an eye
        for detail and the ability to learn and apply new technologies quickly.
        I am confident that I can be an asset to your organization and make
...
const skills = [
  ...
  {
    title: "CHAT-GPT && MICROSOFT COPILOT",
    level: 70,
  },
];
